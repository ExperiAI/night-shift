...
| 12.4–15.2 | title | Instrument Serif 64 px, amber-ink `#ffd58a`, hanging 48 px under the painting and aligned to its left edge (`CAPTION`), at most 796 px wide so it clears the Reels buttons; fade in 0.6 s. The soft note sounds here. |
